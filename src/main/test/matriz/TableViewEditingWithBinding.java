...
public class TableViewEditingWithBinding extends Application {
	public static class TableData {
		...
		public String toString() {
			return "TableData [firstName=" + firstName + ", lastName=" + lastName + ", phone=" + phone + ", email="
					+ email + ", firstNameObject=" + firstNameObject + "]";
		}
	...
	public static class TextFieldCellFactory
		...
		public static class TextFieldCell extends TableCell<TableData, String> {
			...
			public TextFieldCell() {
				...
				// The cell. Though, this is aesthetic only. to each his own.
				// comment out
				// to revert back.
				strCss = "-fx-padding: 0;";
				...
				// -fx-text-box-border, -fx-control-inner-background;" +
						...
						+ /*
							 * Play with this value to center the text depending
							 * on cell height??
							 */
						// "-fx-padding: 0 0 0 0;" +
				...
				textField.focusedProperty().addListener(new ChangeListener<Boolean>() {
					...
					public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue,
						...
						String strStyleLostFocus = // "-fx-background-color:
				...
				textField.hoverProperty().addListener(new ChangeListener<Boolean>() {
					...
					public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue,
						...
						String strStyleGotHover = "-fx-background-color: derive(purple,90%), -fx-text-box-border, derive(-fx-control-inner-background, 10%);"
								+ "-fx-background-insets: 1, 2.8, 3.8;" + "-fx-background-radius: 3.4, 2, 2;";
						String strStyleLostHover = // "-fx-background-color:
													// -fx-shadow-highlight-color,
													// -fx-text-box-border,
													// -fx-control-inner-background;"
													// +
	...
	public static void printNodeKidsRecursively(Node n, String tabs) {
		...
		Parent p = (Parent) n;
		System.out.println(toTab + n.getClass().getName() + "(KIDS="
				+ Integer.toString(p.getChildrenUnmodifiable().size()) + ")" + msg2);
	...
	final ObservableList<TableData> ol = FXCollections.observableArrayList(
